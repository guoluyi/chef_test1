...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "luyiguo-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/guoluyi1"
  #   chef.validation_client_name = "guoluyi1-validator"
  #   chef.validation_key_path = ".chef/guoluyi1-validator.pem"
  # end
end
